...
?>
<!-- <?php print_a($post) ?> -->
<section class="photos_single single">
    <?php if ($latest_posts_query->have_posts()) : ?>
        <?php while (have_posts()) : the_post(); ?>

            <div class="photos_single__header">
                <a class="photos_single__header-redirect" href="<?= $redirectToPostType ?>">
                    <img src="<?= get_template_directory_uri() ?>/assets/redirect-arrow.svg" alt="Arrow svg icon">
                </a>
                <h2 class="photos_single__header-title"><?= ucfirst($post->post_type) ?></h2>
            </div>

            <div class="photos_single__content_wrapper">
                <div class="merge">

                    <div class="photos_single__content_wrapper-img_wrapper">
                        <!-- featured image of the page -->
                        <?php the_post_thumbnail('medium_large', array('class' => 'photos-thumbnail' . " " . $img_ratio)); ?>
                    </div>

                    <div class="photos_single__content_wrapper-content">
                ...
                <div class="photos_single__post_navigation">
